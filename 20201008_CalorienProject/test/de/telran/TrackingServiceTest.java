...
public class TrackingServiceTest {
    ...
    private TrackingService service = new TrackingService(10);
    ...
    @Test
    public void caloriesRemovingFromTotal(){
        service.addCalories(100);
        service.removeCalories(50);
        Assert.assertEquals(50, service.getTotal());
    }

    @Test
    public void checkNonNegativeRemoveCalories(){
        service.removeCalories(50);
        Assert.assertEquals(0,service.getTotal());
    }

    @Test
    public void notNullValueInHistoryByRemoving(){
        service.removeCalories(30);
    ...
    public void isGoalMeet(){
        ...
        service.addCalories(50);
        service.addCalories(20);
        boolean isGoalMeet = service.isGoalMet();
    ...
    public void isGoalNotMeet(){
        ...
        Assert.assertFalse(service.isGoalMet());
    }
}
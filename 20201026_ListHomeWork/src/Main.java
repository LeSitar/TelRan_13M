...
public class Main {
    public static void main(String[] args) {
        ...
        Collections.addAll(names, "Ivan", "Mariya", "Stephan", "John","John","Amalia");
        correctNames(names);
        System.out.println(names);
       /* List<String> newNames = correctListName(names);
    ...
    private static List<String> correctNames(List<String> names){
    ...
    private static List<String> correctListName(List<String > names){
